...
<div id="preloader">
            ...
            <div class="container">
                ...
                <div class="left-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0 thdr1">Change Password</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="swiper-slide">
        <div class="card job-post fgm">
            <div class="card-body">
                <div class="card-info">
                    <div class="container iod">
                        <div class="account-area" style="min-height: auto !important;">
                            <form>
                                ...
                                <div class="input-group">
                                    <a href="login.html" class="btn mt-2 sdf514 w-100 btn-rounded">Submit</a>
                                </div>
                            </form>
                        </div>
                    </div>
